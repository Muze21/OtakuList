...
mixin _$Review {
  ...
  Profile? get user =>
      throw _privateConstructorUsedError; // Relasi ke user profile
...
class _$ReviewImpl implements _Review {
  ...
  @override
  String toString() {
    return 'Review(id: $id, userId: $userId, animeId: $animeId, content: $content, rating: $rating, user: $user, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _Review implements Review {
  ...
  double get rating;
  @override
  Profile? get user; // Relasi ke user profile
  @override
